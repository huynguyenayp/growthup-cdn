...
<div
    ...
    <div class='gu-widget-content'>
        <div class='gu-widget-form'><label class='gu-widget-close' for='off-gu-widget'><svg width='12' height='8' viewBox='0 0 12 8' fill='none'><path d='M6.00018 7.25016C5.90164 7.25063 5.804 7.23141 5.71299 7.19363C5.62197 7.15585 5.53942 7.10027 5.47018 7.03016L0.47018 2.03016C0.370455 1.88426 0.325452 1.70784 0.34311 1.532C0.360767 1.35616 0.43995 1.1922 0.566693 1.06905C0.693436 0.945892 0.859597 0.871447 1.03587 0.858844C1.21214 0.846241 1.38721 0.896289 1.53018 1.00016L6.00018 5.44016L10.4702 1.00016C10.6111 0.90877 10.7787 0.867349 10.946 0.882536C11.1133 0.897724 11.2707 0.968641 11.3929 1.08392C11.5151 1.1992 11.595 1.35217 11.6199 1.5183C11.6448 1.68444 11.6132 1.85412 11.5302 2.00016L6.53018 7.00016C6.46351 7.07572 6.38212 7.13687 6.29098 7.17986C6.19984 7.22285 6.10089 7.24677 6.00018 7.25016Z' fill='#212121'/></svg></label>
            <div
                class='gu-widget-title text-center' id='gu-widget-title'><span>Test 1 </span></div>
        ...
        <form onsubmit='submitForm(); return false;'><label for='gu-email'>Email (*):</label><input type='email' id='gu-email' name='email' required><label for='gu-fullName'>Họ và tên (*):</label><input type='text' id='gu-fullName' name='fullName' required><label for='phone'>Số điện thoại:</label>
            <input type='tel' pattern='(84|0[3|5|7|8|9])+([0-9]{8})&#x5c;b' id='gu-phone' name='gu-phone'><input type='submit' id='gu-label-btn-submit' value='Đăng ký cộng tác viên' name='gu-label-btn-submit'></form>
