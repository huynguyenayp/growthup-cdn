document.addEventListener("DOMContentLoaded", function (events) {
    ...
    if (window.location.pathname.includes("pages/partner")) {
        ...
        function loadCss() {
            ...
            link.rel = "stylesheet";
            link.type = "text/css";
            link.href = "https://cdn.jsdelivr.net/gh/huynguyenayp/growthup-cdn@main/langing_page23.css";
	 ...
	 //    	elmCopyLinkInvite.classList.add('gu-button', 'gu-button__primary', 'gu-mt-30')
		...
		// }
                let elmLogin = `
							...
							<a class="gu-button gu-button__primary gu-mt-30" onclick="function copy(){navigator.clipboard.writeText(${'handleClickCopyLinkInvite'})};copy()">Sao chép link mời</a>
                `;
